...
<Project Type="Project" LVVersion="13008000">
	...
	<Property Name="varPersistentID:{4A886B53-2453-4F33-AD36-18836638F917}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input 2/output</Property>
	<Property Name="varPersistentID:{6E2FA293-B193-4B9C-A77D-57C2E0AA8F95}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input 2/error out</Property>
	<Property Name="varPersistentID:{895A09FB-20DF-4A2B-B8B6-98E76222ABF6}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input/error in</Property>
	<Property Name="varPersistentID:{CD36C01C-AFD0-4500-87A7-621945677F90}" Type="Ref">/myRIO-1900/SharedSystemVariables.lvlib/Puck X</Property>
	<Property Name="varPersistentID:{CD3A88FE-59A6-4E96-A95D-A6F31AF4BDEC}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input 2/input</Property>
	<Property Name="varPersistentID:{CF7AD6A2-52C6-4690-B8D9-8A59548A96D5}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input/output</Property>
	<Property Name="varPersistentID:{EC680640-6A6D-4A32-9633-5D2CBB53AB36}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input 2/error in</Property>
	<Property Name="varPersistentID:{EFBC3CC1-D239-4872-B381-CF7A641383EF}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input/input</Property>
	<Property Name="varPersistentID:{FA6A9437-B43E-45E9-91C6-13506AF8A714}" Type="Ref">/myRIO-1900/SharedSystemVariables.lvlib/Puck Y</Property>
	<Property Name="varPersistentID:{FC27E161-6725-4EA9-AFA0-CCB2579BC747}" Type="Ref">/myRIO-1900/Main.vi/One Shot Rising with Input/error out</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="SharedSystemVariables.lvlib" Type="Library" URL="../../RTFB Integrated Systems/SharedSystemVariables.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
